        ...
        <div style={{maxWidth:680,margin:'0 auto'}}>
          ...
          <p style={{fontSize:14,color:sub,lineHeight:1.7,marginBottom:28,maxWidth:520,margin:'0 auto 28px'}}>
            {es
              ...
              : 'OLIVIA helps your building comply with the CABA Zero Waste Law, certify waste management with artificial intelligence and generate verified carbon credits — all from the superintendent\'s phone.'}
          </p>
      ...
      <section style={{padding:'0 24px 64px',background:dark?'rgba(34,197,94,0.02)':'rgba(34,197,94,0.01)',borderTop:'1px solid rgba(34,197,94,0.1)'}}>
        <div style={{maxWidth:700,margin:'0 auto',paddingTop:64}}>
          ...
          {(es?[
            ...
            {n:'2',t:'The superintendent registers from the phone',d:'With the OLIVIA app, the superintendent photographs the day\'s organic waste. Automatic GPS. AI verifies in seconds. No paperwork or spreadsheets.',c:blue},
...
fs.writeFileSync('app/consorcios/page.tsx', page);
console.log('OK app/consorcios/page.tsx creada');

// Actualizar el card en el landing para apuntar a /consorcios
let landing = fs.readFileSync('app/page.tsx', 'utf8');
landing = landing.replace(
  `<a href="/grandes-generadores" style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'20px',borderRadius:16,background:'linear-gradient(135deg,rgba(34,197,94,0.08),rgba(59,130,246,0.06))',border:'2px solid rgba(34,197,94,0.3)',textDecoration:'none'}}>
...
console.log('OK landing card consorcios apunta a /consorcios');

// Agregar /consorcios al sitemap
if (fs.existsSync('public/sitemap.xml')) {
  let sitemap = fs.readFileSync('public/sitemap.xml', 'utf8');
  if (!sitemap.includes('/consorcios')) {
    sitemap = sitemap.replace(
      '</urlset>',
      `  <url>
    <loc>https://oliviacirculab.com.ar/consorcios</loc>
    ...
    console.log('OK sitemap actualizado con /consorcios');
  }
}

console.log('Listo · npm run build');
