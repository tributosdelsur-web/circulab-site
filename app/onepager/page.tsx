       ...
       <div style={{background:card,border:`1px solid ${border}`,borderRadius:12,padding:'14px',marginBottom:12}}>
         ...
         <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:6}}>
           {(lang==='es'?[
             ...
             '✅ Verificación IA con Gemini Flash',
             '✅ Dashboard OLV + CO2eq + ruta de pagos',
             '✅ Red social OLIVIA con feed y ranking',
             '✅ Simulador de ahorro para consorcios',
             '✅ Admin con CRM y publicación multicanal',
             '✅ Encuesta con datos reales de mercado',
             '✅ Construido con USD 0 de inversión',
           ]:[
             '✅ Web app in production',
             '✅ AI verification with Gemini Flash',
             '✅ OLV + CO2eq + payment path dashboard',
             '✅ OLIVIA social network with feed & ranking',
             '✅ Building savings calculator',
             '✅ Admin with CRM and multichannel publishing',
             '✅ Survey with real market data',
