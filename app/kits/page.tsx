  ...
  const KITS = [
    ...
    },
    {
      ...
      incluye: es ? [
        ...
        'Priority in the certification process',
      ],
    ...
    },
    {
      ...
      incluye: es ? [
        ...
        'Acceso anticipado a Quincena PULSO',
      ] : [
        ...
        'Early access to Quincena PULSO',
      ],
    ...
    },
    {
      ...
      incluye: es ? [
        ...
        'Certificate in company name once the process is complete',
