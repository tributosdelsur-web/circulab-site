      ...
      <section style={{padding:'32px 20px',maxWidth:580,margin:'0 auto',borderTop:`1px solid ${border}`}}>
        ...
        <div style={{background:'rgba(245,158,11,0.04)',border:'1px solid rgba(245,158,11,0.15)',borderRadius:10,padding:'12px',marginBottom:16}}>
          <div style={{fontSize:10,color:sub,lineHeight:1.6,fontStyle:'italic'}}>
            {es?'⚠️ Los valores son estimados y dependen de la conducta responsable del ciudadano al reciclar, las certificaciones que se obtengan con Verra y otras certificadoras, y el precio del mercado de carbono en cada tramo. OLIVIA crea el sistema, lo valida, lo certifica y permite que todos lo utilicemos. El sistema es de todos: todos recibimos algo cuando se distribuye. OLIVIA no paga — el mercado de carbono paga.':'⚠️ Values are estimates and depend on the citizen\'s responsible recycling behavior, certifications obtained with Verra and other certifiers, and the carbon market price per stage. OLIVIA creates, validates and certifies the system so everyone can use it. The system belongs to everyone. OLIVIA doesn\'t pay — the carbon market pays.'}
          </div>
        </div>
